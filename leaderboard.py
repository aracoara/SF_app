...
from tennis_app.models.models import Player, Game, Pick, User, RoundType
from flask_sqlalchemy import SQLAlchemy
from sqlalchemy import create_engine
from tennis_app import app, db  # Substitua pelo nome da sua aplicação Flask
import pandas as pd
# from tennis_app.utils.utils import create_games
...
def process_results_data(file_path_r2):
    ...
    return df[['qf_number', 'name', 'player_id']]
...
#             lost_points = 0
#             # Obter todos os palpites do usuário atual
